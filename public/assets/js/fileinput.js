...
(function (factory) {
        ...
        _initTemplateDefaults: function () {
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    removeErrorClass: 'btn  btn-danger',
                    removeTitle: 'Remove file',
                    uploadIcon: '<i class="glyphicon glyphicon-upload"></i>',
                    uploadClass: 'btn  btn-default btn-outline-secondary',
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonIcons: {
            prev: '<i class="fas fa-arrow-circle-left"></i>',
            next: '<i class="fas fa-arrow-circle-right"></i>',
            toggleheader: '<i class="fas fa-arrows-alt-v"></i>',
            fullscreen: '<i class="fas fa-expand-arrows-alt"></i>',
            borderless: '<i class="fas fa-sort"></i>',
            close: '<i class="fas fa-times"></i>'
        },
        previewZoomButtonClasses: {
            prev: 'btn btn-navigate',
            next: 'btn btn-navigate',
            toggleheader: 'btn ml-1 btn-default btn-outline-secondary',
            fullscreen: 'btn ml-1 btn-default btn-outline-secondary',
            borderless: 'btn ml-1 btn-default btn-outline-secondary',
            close: 'btn ml-1  btn-default btn-outline-secondary'
        },
